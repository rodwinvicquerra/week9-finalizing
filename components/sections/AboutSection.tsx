    ...
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 bg-background relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <Card className="p-8 hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary/30">
          ...
          <Card className="p-8 hover:shadow-2xl transition-all duration-300 border-2 hover:border-accent/30">
            <h3 className="text-2xl font-bold mb-4 flex items-center gap-2">
        ...
        {/* Goals */}
        <Card className="mt-8 p-8 hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-primary/5 to-accent/5 border-2 border-primary/20">
